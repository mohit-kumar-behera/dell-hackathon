...
class Product(models.Model):
  ...
  quantity = models.IntegerField(default=1, blank=True, null=True, validators =[positive_value])
  price = models.FloatField(default=0, blank=True, null=True, validators =[positive_value])
